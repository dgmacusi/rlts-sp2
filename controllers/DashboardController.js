...
module.exports = {
	...
	getSystemActivity2 : function (req, res, next) {
  		Dashboard.getSystemActivity(req.body.fromDate, req.body.toDate, function (err, output) {
			res.json(output)
		})
	}, 
	getLocationActivity2 : function (req, res, next) {
  		Dashboard.getLocationActivity(req.body.fromDate, req.body.toDate, function (err, output) {
			res.json(output)
		})
	},
	getTopLocations2 : function (req, res, next) {
		Dashboard.getTopLocations(req.body.fromDate, req.body.toDate, function (err, output) {
			res.json(output)
		})
	}
}
